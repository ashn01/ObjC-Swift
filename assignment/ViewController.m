...
- (void)viewDidLoad {
    ...
    NSArray* nameArr = [NSArray arrayWithObjects:@"shoes",@"pants",@"shirt",@"dress", nil];
    NSArray* quanArr = [NSArray arrayWithObjects:[NSNumber numberWithInt:10],[NSNumber numberWithInt:5],[NSNumber numberWithInt:10],[NSNumber numberWithInt:10], nil];
    NSArray* pricArr = [NSArray arrayWithObjects:[NSNumber numberWithDouble:300.99],[NSNumber numberWithDouble:109.99],[NSNumber numberWithDouble:99.99],[NSNumber numberWithDouble:499.99], nil];
