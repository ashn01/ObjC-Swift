...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [[self.historyArray objectAtIndex:indexPath.row] name];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@",[[self.historyArray objectAtIndex:indexPath.row] quantity]];
    return cell;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"cellSegue"])
    {
        ...
        hdvc.historyItem = [self.historyArray objectAtIndex: [[self.tableView indexPathForSelectedRow] row]];
    }
}
